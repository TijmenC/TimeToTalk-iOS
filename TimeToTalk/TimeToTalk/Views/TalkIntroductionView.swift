...
struct TalkIntroductionView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                NavigationLink(
                    destination: TalkAnswersView(contentMessage: answer, subject: subject, anonymous: anonymous, audioRecorder: AudioRecorder(), rootIsActive: self.$rootIsActive)) {
...
struct TalkIntroductionView_Previews: PreviewProvider {
    static var previews: some View {
        TalkIntroductionView(audioRecorder: AudioRecorder(), subject: "school", anonymous: false, rootIsActive: .constant(true))
    }
}
