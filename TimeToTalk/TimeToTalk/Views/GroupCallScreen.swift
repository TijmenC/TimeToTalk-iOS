    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                VStack {
                Image(systemName: "person.circle.fill").padding()
                    .font(Font.system(size: 60)).foregroundColor(DataSource.thirdUser.color)
                    Text(DataSource.thirdUser.name).font(.title3)
                }
                .padding(.bottom, 170)
                VStack {
                Image(systemName: "person.circle.fill").padding()
                    .font(Font.system(size: 60)).foregroundColor(DataSource.fourthUser.color)
                    Text(DataSource.fourthUser.name).font(.title3)
                }
                .padding(.bottom, 170)
...
struct GroupCallScreen_Previews: PreviewProvider {
